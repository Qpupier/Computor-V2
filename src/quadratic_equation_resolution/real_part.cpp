...
/*   Updated: 2026/04/21 17:46:05 by qpupier          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
	...
	Rational* real_term3_factor, Rational* real_denominator, Rational* real_gcd)
{
	...
	solutions.real_term1 = tmp->getNumerator();
	delete tmp;
	tmp = *real_term2_factor / *real_gcd;
	solutions.real_term2_factor = tmp->getNumerator();
	delete tmp;
	tmp = *real_term3_factor / *real_gcd;
	solutions.real_term3_factor = tmp->getNumerator();
	delete tmp;
	tmp = *real_denominator / *real_gcd;
	solutions.real_denominator = tmp->getDenominator();
	delete tmp;
}
