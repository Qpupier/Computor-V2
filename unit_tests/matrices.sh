...
echo "\033[34;1mTesting matrices in a single expression\033[0m\n"
...
run_error "[[0, 1, 2];[3, 4*, 5];[6, 7, 8]]" "Invalid matrix format: Operator cannot be at the beginning or end of an expression" $1 ; status=$((status | $?))
